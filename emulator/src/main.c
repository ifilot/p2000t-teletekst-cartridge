...
static void automatic_keyboard(int frame){static int stage,pressed=-1,release_frame,legacy_warning_seen;
  ...
  else if(stage==3&&frame>=150&&screen_has("KIES BRON (1-2)")){code=auto_source==2?63:46;stage++;}
  else if(stage>=4&&(frame==auto_pause_frame||frame==auto_resume_frame)){code=53;}
