...
enum p2wp_type {
    ...
    P2WP_TYPE_VERSION_CHECK_START = 0x05,
    P2WP_TYPE_VERSION_CHECK_STATUS = 0x06,
...
#define P2WP_TELETEKST_AUTOSTART_DISABLED 0xffu
#define P2WP_TELETEKST_MENU_SOURCE_CUSTOM 0u
#define P2WP_TELETEKST_MENU_SOURCE_NOS 1u
#define P2WP_TELETEKST_MENU_SOURCE_P2000T 2u
#define P2WP_TELETEKST_MENU_SOURCE_ARCHIVE 3u

enum p2wp_teletekst_source {
    P2WP_TELETEKST_SOURCE_NOS = 0,
    P2WP_TELETEKST_SOURCE_P2000T = 1,
    P2WP_TELETEKST_SOURCE_CUSTOM = 2,
    P2WP_TELETEKST_SOURCE_ARCHIVE = 3,
};

/** Stable errors returned in TELETEKST_FETCH_STATUS. */
enum p2wp_teletekst_error {
    P2WP_TELETEKST_ERROR_NONE = 0,
    P2WP_TELETEKST_ERROR_NOT_CONNECTED = 1,
    P2WP_TELETEKST_ERROR_TLS_CONFIG = 2,
    P2WP_TELETEKST_ERROR_REQUEST_START = 3,
    P2WP_TELETEKST_ERROR_NETWORK = 4,
    P2WP_TELETEKST_ERROR_HTTP_STATUS = 5,
    P2WP_TELETEKST_ERROR_TOO_LARGE = 6,
    P2WP_TELETEKST_ERROR_INVALID_DATA = 7,
    P2WP_TELETEKST_ERROR_PAGE_NOT_FOUND = 8,
    P2WP_TELETEKST_ERROR_DNS = 9,
    P2WP_TELETEKST_ERROR_CONNECT = 10,
    P2WP_TELETEKST_ERROR_CONNECTION_CLOSED = 11,
    P2WP_TELETEKST_ERROR_TIMEOUT = 12,
    P2WP_TELETEKST_ERROR_OUT_OF_MEMORY = 13,
    P2WP_TELETEKST_ERROR_CONTENT_LENGTH = 14,
    P2WP_TELETEKST_ERROR_LOCAL_ABORT = 15,
};
...
enum p2wp_capability {
    ...
    P2WP_CAPABILITY_VERSION_CHECK = 1u << 5,
};

enum p2wp_hardware_model {
    P2WP_HARDWARE_UNKNOWN = 0,
    P2WP_HARDWARE_PICO_W = 1,
    P2WP_HARDWARE_PICO_2_W = 2,
};

enum p2wp_version_check_state {
    P2WP_VERSION_CHECK_IDLE = 0,
    P2WP_VERSION_CHECK_RUNNING = 1,
    P2WP_VERSION_CHECK_COMPLETE = 2,
    P2WP_VERSION_CHECK_FAILED = 3,
};
